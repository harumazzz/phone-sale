...
final class OrderDetailWithItemsLoaded extends OrderState {
  const OrderDetailWithItemsLoaded({required this.orderWithItems});
  final OrderWithItems orderWithItems;

  @override
  List<Object?> get props => [orderWithItems];
}
