    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text('Chưa có đơn hàng nào', style: theme.textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.bold)),
                ...
                children: [
                  OutlinedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => OrderDetailScreen(orderId: order.orderId!)),
                      );
                    },
